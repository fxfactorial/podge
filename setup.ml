...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0df9141a982de249295cee4bf0e04b9b) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "If you're doing any modern OCaml then you're doubtlessly annoyed by the state of libraries and committing to one of the big ones can be restricting. Podge is a single modules containing specialized modules for their respectives usages for seemginly common tasks."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\138\018\1422gÝ¶ ð-âÏÆ\0194Ü";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
